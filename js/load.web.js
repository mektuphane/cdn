...
loadScripts([
	"http://localhost:8888/cdn/js/jquery-1.11.1.min.js",
    ...
    "http://localhost:8888/cdn/js/bootstrap-multiselect.js",
    // "http://davidstutz.github.io/bootstrap-multiselect/js/bootstrap-multiselect.js",
    "http://localhost:8888/cdn/js/remoteNonStopPageScroll.js",
    "http://localhost:8888/cdn/js/bootstrap-maxlength.min.js",
    "http://localhost:8888/cdn/js/holder.js",
    "http://localhost:8888/cdn/js/attach.web.js",
    "http://localhost:8888/cdn/js/main.web.js"
],function(){
    console.info('loaded.');
});